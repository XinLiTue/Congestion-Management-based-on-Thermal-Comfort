...
def plotPMVrange(df,median_PPD, ta_range,saveFigure=False):
    ...
    # Create the boxplot
    sns.boxplot(x="Ta", y="PPD", data=df, showfliers=False, color=cmap(0.1))
...
if __name__ == "__main__":
    ...
    fileloc =     "data/db_measurements_v2.1.0.csv" #measurements
    metadataloc =       "data/db_metadata.csv" #metadata
